...
#
# same as python_scripts/plot_necess_condns_grouped.py, but I make 
# the axes tighter so I can summarise visually
...
xy_max = 5 # plot range 0 <= x, y <= xy_max (c = 1)
default_c = 1
default_delta = 1 
...
for q_sequence in q_sequences:
    ...
    for idx in df.index:
        ...
        file_path = results_dir / "tight_plots" / fname_out
